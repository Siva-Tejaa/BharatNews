            ...
            <>
             {
                Array(3).fill("").map((arr,index) =>(
                  <div key={index} className='bg-white shadow-[0_0_6px_0_rgba(121,121,121,0.3)] my-5 p-2 rounded-md hover:shadow-[0_0_10px_0_rgba(121,121,121,0.3)] flex flex-col gap-1 w-[340px] tablet:w-[475px] laptop:w-[750px] laptop:flex laptop:flex-row'>
